...
regular_verb_list = [
    ...
    'kojar', 'p*nar', 'parar', 'pasar', 'sakar', 'tamar', 'tokar', 'tomar', 'Bar', 'Dexar', 'romper',
    'xalar', 'xuGar', 'G&rDar', 'Gustar', 'sentar', 'aGaRar', 'ajuDar', 'b-lar', 'B#ner', 'D$rmir',
    'pasear', 'prestar', 'Bisitar', 'Golpear', 'dexar', 'aG&rDar', 'ense|ar',
    'aReGlar', 'estar', 'faltar', 's#Rar' # ask about this one 
    'saluDar', 'enkontrar', 'Ber', 'ber', 'Baer', 'aser', 'kaer', 'rekoxer', 'g&rDar',
    ...
    't#ner', 'tener', 'tener', 'poner', 's#ntar', 'mirar', 'komer',  'star', 'salGar', 'jamar', 'traer'
]
...
all_invalid = [ 
    ...
    "met/elo", "b/raBo", "D/$rmelo", "D/entro", "mir/%m", "B/ente", "B/arko", "B/arku",
    "B/arku", "D/os", "tom/", "b/en", "ka/xa", "b/u", "Ba/kas", "par/a", "ka/ju", "B/loke",
